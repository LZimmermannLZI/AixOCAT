...
for %%i in (.\AixOCAT\Examples\HeatSupplyCircle\HeatingSupplySystem\ProgrammHalle\POUs\Components\*.TcPOU) do (
	mklink /H .\AixOCAT\Examples\Tests\TcUnit_Tests\TcUnit_Tests\TcUnit_Tests\POUs\%%~nxi %%i
)
pause